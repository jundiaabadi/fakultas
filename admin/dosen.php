                ...
                <div class="mb-3">
                    <form method="GET" action="">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control-sm-lg" placeholder="Cari Dosen">
                            <button type="submit" class="btn btn-primary mx-3 rounded">Cari</button>
                        </div>
                    </form>
                </div>
                <a href="tambah-dosen.php" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Tambah
                    Dosen</a>
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        $dosen = mysqli_query($conn, "SELECT * FROM dosen ".$condition." ORDER BY id DESC");
                        ...
                        <tr class="text-center border">
                            ...
                            <td class="border"><img src="../uploads/dosen/<?= $p['gambar'] ?>" width="100px"></td>
                            <td class="border">
                                <a href="edit-dosen.php?iddosen=<?= $p['id'] ?>" class="text-decoration-none"
                                    style="color: #ffbb00;"><i class="fa-solid fa-pen-to-square"
                                        style="color: #ffbb00;"></i> Edit</a>
                                |
                                <a href="hapus.php?iddosen=<?= $p['id'] ?>" class="text-decoration-none"
